      ...
      <div>
        ...
        <div>
          ...
          <input
            ...
            @input="${(e: any) => { this.fillStyle = e.target.value }}"
          />
          <br>
          線:
          <input
            ...
            @input="${(e: any) => { this.strokeStyle = e.target.value }}"
          />
          <br>
          重力x:
          <input
            ...
            type="range"
            value="${this.gravityX}"
            @input="${(e: any) => { this.gravityX = e.target.value }}"
          />
          <br>
          重力y:
          <input
            ...
            type="range"
            value="${this.gravityY}"
            @input="${(e: any) => { this.gravityY = e.target.value }}"
          />
        </div>
      </div>`
  }
